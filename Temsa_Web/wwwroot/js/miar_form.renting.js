import {
    ...
    style_div_info_height_IT, addMsgWithImgToDivArticlesAsync, alignArticlesAsAutoAsync, getArticleCountOnOneRowAsync
...
$(function () {
    ...
    const pagination_headerNames = {
        ...
        "accepted": "Form-R-Accepted",
        "rejected": "Form-R-Rejected"
    }
