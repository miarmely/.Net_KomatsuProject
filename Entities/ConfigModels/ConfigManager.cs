...
namespace Entities.ConfigModels
{
	public class ConfigManager : IConfigManager
	{
		...
		private readonly Lazy<ErrorMessagesConfig> _errorMessages;
		...
		public ErrorMessagesConfig ErrorMessages => _errorMessages.Value;
        ...
        public ConfigManager(IOptions<UserSettingsConfig> userSettings,
			...
			IOptions<ErrorMessagesConfig> errorMessages)
        {
			...
			_errorMessages = new Lazy<ErrorMessagesConfig>(() => errorMessages.Value);
        }
